...
let full_stim = [];
  ...
  for (let i = 0; i < catchStim.length; i++){
    full_stim.push({stimulus: catch_stimuli[i], data: {stimulus: catchStim[i], stim: "U0"+catchStim[i]+".png", test_part: 'scrambed_upright', correct_response: '0', incorrect_response: '1'}},)
  }
  for (let i = 0; i < catchStim.length; i++){
    full_stim.push({stimulus: catch_stimuli_inverted[i], data: {stimulus: catchStim[i]+"-180.png", stim: "U0"+catchStim[i]+"-180.png", test_part: 'scrambled_inverted', correct_response: '0', incorrect_response: '1'}},)
  }
