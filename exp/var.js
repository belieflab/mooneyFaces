...
const catchStim = [ '005', '025', '030', '031', '032', '033', '039','040', '098', '100'];
...
for (let i = 0; i < catchStim.length; i++){
  catch_stimuli.push("stimuli/scrambled/S0" + catchStim[i] + ".bmp");
...
let full_stim = [];
  ...
  for (let i = 0; i < catchStim.length; i++){
    full_stim.push({stimulus: catch_stimuli[i], data: {stimulus: catchStim[i], stim: "S000"+catchStim[i]+".bmp", test_part: 'catch', correct_response: '', incorrect_response: ''}},)
  }
