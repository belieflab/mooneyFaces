...
const catchStim = [ '27.4', '29.4', '37.4', '38.4'];
...
for (let i = 0; i < catchStim.length; i++){
  ...
  catch_stimuli.push("stimuli/scrambled/inverted/my_bitmap" + catchStim[i] + "(scrambled).bmp");
...
let full_stim = [];
  ...
  for (let i = 0; i < catchStim.length*2; i++){
    full_stim.push({stimulus: catch_stimuli[i], data: {stimulus: catchStim[i], stim: catchStim[i]+"(scrambled).bmp", test_part: 'catch', correct_response: '', incorrect_response: ''}},)
  }
