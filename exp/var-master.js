...
const upright              = ['26.2', '45.2', '19.2', '24.2', '9.2', '20.2', '41.2', '39.2', '43.2', '22.2', '44.2', '25.2', '18.2', '27.2', '46.2', '42.2', '23.2', '21.2', '8.2', '38.2', '40.2', '34.2', '4.2', '10.2', '12.2', '6.2', '36.2', '32.2', '16.2', '14.2', '29.2', '30.2', '13.2', '7.2', '37.2', '35.2', '5.2', '11.2', '28.2', '15.2', '31.2', '33.2', '17.2'];
const upright_ground_truth = [];
...
for (let i = 0; i < upright.length ; i++){
  upright_stimuli.push("stimuli/original/my_bitmap" + upright[i] + ".jpg");
...
let full_stim = [];
  for (let i = 0; i < upright.length ; i++){
    full_stim.push({stimulus: upright_stimuli[i], data: {stimulus: unright[i], stim: unright[i]+".jpg", test_part: 'upright', ground_truth: upright_ground_truth[i], correct_response: '1', incorrect_response: '0'}},)
  }
  for (let i = 0; i < inverted.length ; i++){
